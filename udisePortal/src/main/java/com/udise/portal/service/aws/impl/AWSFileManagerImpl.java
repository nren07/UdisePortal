package com.udise.portal.service.aws.impl;
...
@Component
@Slf4j
public class AWSFileManagerImpl implements InitializingBean, AWSFileManager {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AWSFileManager.class);
